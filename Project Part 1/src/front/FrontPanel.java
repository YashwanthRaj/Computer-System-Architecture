...
public class FrontPanel {
    ...
    private void initComponents() {
        ...
        frmCsciClassProject.getContentPane().setBackground(new Color(255, 128, 255));
        frmCsciClassProject.setTitle("CSCI-6461 | GROUP4 | COMPUTER SIMULATOR");
        ...
        pnlRegisters.setBackground(new Color(255, 128, 255));
        pnlRegisters.setBounds(50, 129, 780, 716);

        pnlR3 = new JPanel();
        pnlR3.setBackground(new Color(255, 128, 255));

        lblR_3 = new JLabel("R3");
        lblR_3.setBounds(100, 100, 1097, 980);
        pnlR3.add(lblR_3);
        ...
        pnlX1 = new JPanel();
        pnlX1.setBackground(new Color(255, 128, 255));
        ...
        pnlX2 = new JPanel();
        pnlX2.setBackground(new Color(255, 128, 255));
        ...
        pnlX3 = new JPanel();
        pnlX3.setBackground(new Color(255, 128, 255));
        ...
        pnlMAR = new JPanel();
        pnlMAR.setBackground(new Color(255, 128, 255));
        ...
        pnlMBR = new JPanel();
        pnlMBR.setBackground(new Color(255, 128, 255));
        ...
        pnlMSR = new JPanel();
        pnlMSR.setBackground(new Color(255, 128, 255));
        ...
        pnlIR = new JPanel();
        pnlIR.setBackground(new Color(255, 128, 255));
        ...
        pnlPC = new JPanel();
        pnlPC.setBackground(new Color(255, 128, 255));
        ...
        pnlR0 = new JPanel();
        pnlR0.setBackground(new Color(255, 128, 255));
        ...
        //JPanel master_reg_panel = new JPanel();
        
        pnlR1 = new JPanel();
        pnlR1.setBackground(new Color(255, 128, 255));
        ...
        pnlR2 = new JPanel();
        pnlR2.setBackground(new Color(255, 128, 255));
        ...
        pnlCC = new JPanel();
        pnlCC.setBackground(new Color(255, 128, 255));
        ...
        btnIPL.setBounds(888, 45, 145, 28);

        testPanel = new JPanel();
        testPanel.setBackground(new Color(255, 128, 255));
        testPanel.setBounds(838, 209, 208, 165);
        ...
        pnlAddress.setBackground(new Color(255, 128, 255));
        testPanel.add(pnlAddress);
        pnlAddress.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));

        lblAddress = new JLabel("Address");
        lblAddress.setBackground(new Color(255, 128, 255));
        ...
        pnlValue = new JPanel();
        pnlValue.setBackground(new Color(255, 128, 255));
        ...
        pnlButton.setBackground(new Color(255, 128, 255));
        ...
        pnlOp = new JPanel();
        pnlOp.setBackground(new Color(255, 128, 255));
        pnlOp.setBounds(21, 63, 715, 41);
        pnlOp.setLayout(new FlowLayout(FlowLayout.RIGHT, 5, 5));

        pnlIns = new JPanel();
        pnlIns.setBackground(new Color(255, 128, 255));
        pnlOp.add(pnlIns);
        ...
        pnlProgram1.setBackground(new Color(255, 128, 255));
...
//        pnlFR1.add(btnStoreFR1);
                ...
                pnlMFR = new JPanel();
                pnlMFR.setBackground(new Color(255, 128, 255));
...
//        frmCsciClassProject.getContentPane().add(pnlCache);
        ...
        pnlKeyb = new JPanel();
        pnlKeyb.setBackground(new Color(255, 128, 255));
        pnlKeyb.setBounds(792, 431, 254, 201);
